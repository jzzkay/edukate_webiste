    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owner', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='courses.teacher')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='course',
            name='owner',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='courses', to='courses.teacher'),
        ),
        migrations.CreateModel(
            name='Text',
            fields=[
